...
from datagenx.extract_schema import annotate_table_with_statistics
from datagenx.schema_extractor import available_extractor_types, connection_kwargs_for, create_schema_extractor
...
def _project_root():
    # Resolved centrally rather than by counting ".." from this file, which
    # silently returns the wrong directory whenever the package moves.
    from datagenx.config import REPO_ROOT
